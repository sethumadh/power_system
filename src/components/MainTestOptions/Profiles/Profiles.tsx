    ...
    <>
      <div className="flex flex-wrap">
        <div className="w-full">
          ...
          >
            <li
              className={`-mb-px mx-2 last:mr-0  text-xs font-bold uppercase px-5 py-3 shadow-lg rounded leading-normal cursor-pointer ${
            ...
            <li
              className={`-mb-px mr-2 last:mr-0  text-xs font-bold uppercase px-5 py-3 shadow-lg rounded leading-normal cursor-pointer ${
